...
import {
  ...
  moldRemediationCategoryServices,
...
export async function generateStaticParams() {
  // Data files arriving in parallel from seo-writer — wire-up pass coming.
  return moldRemediationCategoryServices.map((cfg) => ({ slug: cfg.slug }))
}
...
export default async function MoldRemediationServicePage({
  params,
}: {
  params: Promise<{ slug: string }>
}) {
