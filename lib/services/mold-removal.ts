...
export const moldRemoval: ServiceConfig = {
  slug: "mold-removal",
  href: "/mold-remediation/mold-removal",
  h1: "Mold Removal Aledo // IICRC S520 Containment, HEPA & Clearance Testing",
  name: "Mold Removal",
  metaTitle: "Mold Removal Aledo, TX | S.W.A.T. Restoration",
  metaDescription:
    "Mold removal in Aledo & Fort Worth, TX. S.W.A.T. Restoration follows IICRC S520 — 6-mil containment, negative air pressure, HEPA-vac, Concrobium antimicrobial, and clearance air testing.",
  heroPainLine:
  ...
  processSteps: [
    {
      number: "01",
      label: "Containment",
      title: "Seal the Zone Before the First Disturbance.",
      description:
    ...
    },
    {
      number: "02",
      label: "Removal",
      title: "HEPA-Vac First. Remove Contaminated Materials.",
      description:
    ...
    },
    {
      ...
      title: "Concrobium or Microban on All Treated Surfaces.",
      description:
    ...
    {
      number: "04",
      label: "Clearance Testing",
      title: "Third-Party Air Sampling. Not Our Word Alone.",
      description:
  ...
  whySwatPillars: [
    {
      title: "IICRC S520-Compliant. Containment Before Any Disturbance.",
      bullets: [
    ...
    {
      title: "Third-Party Clearance Testing. Not Self-Certified.",
      bullets: [
    ...
    {
      title: "One Team Through Remediation and Reconstruction.",
      bullets: [
  ...
  faqs: [
    {
      question: "Why does mold removal require containment and negative air pressure?",
      answer:
        "Mold colonies release spores continuously — and disturbing them during removal dramatically increases airborne spore concentrations in the immediate area. Without containment and negative air pressure, those spores migrate through HVAC systems and air currents into clean areas of the structure, colonizing new surfaces wherever they find moisture. The IICRC S520 standard requires containment and negative pressure specifically to prevent this cross-contamination. S.W.A.T. Restoration establishes containment and runs HEPA-filtered negative air machines before any mold material is disturbed.",
    },
    {
      question: "How long does mold remediation take in an Aledo home?",
      answer:
        "A contained single-room remediation with a clear moisture source that has been addressed typically takes 2 to 4 days: containment setup, removal, antimicrobial application, and clearance testing turnaround. Multi-room remediation, crawl-space mold on framing, or jobs where the moisture source was active for an extended period can run 5 to 10 days depending on material scope. Lab clearance results take 3 to 5 business days from sampling — the project is not complete until clearance is confirmed.",
    },
    {
      question: "Does insurance cover mold remediation?",
      answer:
        "Coverage depends on the underlying cause. Mold resulting from a sudden and accidental covered water event — burst pipe, appliance failure, roof leak — is typically covered under standard Texas homeowner policies, including remediation costs, containment, and disposal. Mold from long-term neglect, chronic leaks, or humidity issues is typically excluded. S.W.A.T. Restoration documents the remediation scope and ties it to the covered water loss — formatted for adjuster review, with direct billing to most major carriers.",
    },
    {
      question: "What happens to the drywall and insulation removed during mold remediation?",
      answer:
        "Contaminated drywall, insulation, and other porous materials that cannot be cleaned are removed from the structure and double-bagged in polyethylene for disposal per Texas Commission on Environmental Quality (TCEQ) guidelines. Mold-contaminated materials are not recyclable. Disposal is documented in the project file. After removal, structural framing that remains is cleaned mechanically, treated with Concrobium or Microban antimicrobial, and cleared before reconstruction materials are installed.",
    },
    {
      question: "How do I know the mold removal was done correctly?",
      answer:
