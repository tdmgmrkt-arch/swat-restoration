...
export const insuranceClaims: ServiceConfig = {
  slug: "insurance-claims",
  href: "/reconstruction/insurance-claims",
  h1: "Insurance Claim Assistance Aledo // Xactimate, Adjuster Meetings & Direct Billing",
  name: "Insurance Claim Assistance",
  metaTitle: "Insurance Claim Assistance Aledo, TX | S.W.A.T. Restoration",
  metaDescription:
    "Insurance claim assistance in Aledo & Fort Worth, TX. S.W.A.T. Restoration writes Xactimate estimates, meets your adjuster, submits supplements, and bills your carrier directly for water, fire, and mold losses.",
  heroPainLine:
  ...
  processSteps: [
    {
      number: "01",
      label: "First-Response Documentation",
      title: "The Insurance File Starts When the Crew Arrives.",
      description:
    ...
    },
    {
      ...
      title: "Adjuster-Standard Scope Writing. Line Item by Line Item.",
      description:
    ...
    },
    {
      ...
      title: "On-Site. Walking the Damage Together.",
      description:
    ...
    {
      number: "04",
      label: "Supplements & Closeout",
      title: "Gaps Identified. Supplements Submitted. Claim Closed.",
      description:
  ...
  whySwatPillars: [
    {
      title: "Xactimate Scope Writing. The Language Adjusters Speak.",
      bullets: [
    ...
    {
      title: "Adjuster Meetings and Supplement Requests Handled by S.W.A.T.",
      bullets: [
    ...
    {
      title: "One Team. One File. Every Trade Covered.",
      bullets: [
  ...
  faqs: [
    {
      question: "What is Xactimate and why does it matter for my insurance claim?",
      answer:
        "Xactimate is the estimating software used by most Texas homeowner insurance carriers and their adjusters to calculate the cost of restoration and reconstruction losses. It prices work at the local market rate, line item by line item — labor, materials, and equipment — using a database updated monthly by Verisk Analytics. When a contractor submits an estimate in Xactimate format, the adjuster can compare it directly against their internal estimate and process it without manual conversion. A narrative estimate or a lump-sum contractor quote requires the adjuster to convert it manually — introducing delays and disputes. S.W.A.T. Restoration writes in Xactimate from the first scope walk.",
    },
    {
      question: "What should I do when my insurance adjuster arrives for the inspection?",
      answer:
        "When S.W.A.T. Restoration is involved, the homeowner does not need to manage the adjuster walkthrough alone. S.W.A.T. Restoration schedules to be on-site during the adjuster inspection — walking every affected area with documentation in hand. The homeowner's role is to grant access, answer questions about the loss event itself (when it was discovered, what the source was), and sign the authorization documents the adjuster requires. The technical scope discussion — what framing moisture content means, why HVAC decontamination is included, what makes a shingle count as damaged — is handled by S.W.A.T. Restoration.",
    },
    {
      question: "What happens if the adjuster's estimate is lower than the actual damage?",
      answer:
        "Supplement requests are the mechanism for addressing an underestimated initial scope. S.W.A.T. Restoration compares every line item in the adjuster's Xactimate estimate against the documented scope and identifies omissions — items visible in photos or measured in moisture logs that were excluded from the approved estimate. Each omission becomes a supplement line item submitted with supporting evidence. Most supplement requests on well-documented losses are resolved within 2 to 4 weeks. If a supplement is denied without reasonable basis, S.W.A.T. Restoration can provide the documentation package to a public adjuster for independent representation.",
    },
    {
      question: "Does S.W.A.T. Restoration bill my insurance directly?",
      answer:
        "S.W.A.T. Restoration bills most major Texas homeowner carriers directly for covered restoration and reconstruction work after the scope is approved. The homeowner is responsible for the deductible amount — which is collected at project completion rather than in advance for most covered losses. The carrier pays S.W.A.T. Restoration directly for the balance of the covered scope. Any work outside the covered scope — upgrades elected by the homeowner, non-covered causes — is billed separately to the homeowner.",
    },
    {
      question: "How long does it take to get an insurance claim approved for water or fire damage?",
      answer:
