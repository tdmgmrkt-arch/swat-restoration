...
export const airQuality: ServiceConfig = {
  slug: "air-quality",
  href: "/mold-remediation/air-quality",
  h1: "Indoor Air Quality Restoration Aledo // Post-Remediation Clearance & IAQ",
  name: "Indoor Air Quality Restoration",
  metaTitle: "Indoor Air Quality Restoration Aledo, TX | S.W.A.T. Restoration",
  metaDescription:
    "Indoor air quality restoration in Aledo & Fort Worth, TX. S.W.A.T. Restoration provides clearance testing, HVAC duct cleaning, and MERV filtration guidance after mold remediation.",
  heroPainLine:
  ...
  processSteps: [
    {
      ...
      title: "Third-Party Clearance. Objective Lab Results.",
      description:
    ...
    {
      number: "02",
      label: "HVAC Assessment",
      title: "If the System Ran During the Mold Event, the Ducts Need Attention.",
      description:
    ...
    {
      number: "03",
      label: "Filtration Upgrade",
      title: "MERV Rating That Matches the Air Quality Goal.",
      description:
    ...
    {
      number: "04",
      label: "Humidity-Control Guidance",
      title: "Prevent the Next Mold Event.",
      description:
  ...
  whySwatPillars: [
    {
      title: "Third-Party Clearance. Independent from the Remediation Crew.",
      bullets: [
    ...
    {
      title: "HVAC Is Not an Afterthought.",
      bullets: [
    ...
    {
      title: "Texas Humidity Guidance That's Actually Local.",
      bullets: [
  ...
  faqs: [
    {
      question: "What is post-remediation clearance testing and why does it matter?",
      answer:
        "Post-remediation clearance testing uses Air-O-Cell air sampling to confirm that indoor spore species and concentrations have returned to levels consistent with the outdoor baseline after mold remediation is complete. It matters because a remediation job that disturbed colonies can leave elevated spore counts in areas that look visually clean — in HVAC systems, on horizontal surfaces, or in rooms adjacent to the work zone. Without lab-confirmed clearance, the homeowner has no objective proof the air is safe, and no documentation for insurance or real-estate purposes.",
    },
    {
      question: "How do I keep mold from coming back after remediation in an Aledo home?",
      answer:
        "Mold prevention in a North Texas home requires managing three variables: moisture source, relative humidity, and substrate availability. Fix the active moisture source first — the leaking condensate line, the slab crack, the exhaust fan ducted to the attic. Maintain indoor relative humidity below 55% year-round — Parker County summer dewpoints above 65°F mean a standard air conditioner alone may not hold that target without a whole-home dehumidifier. Replace porous materials that have been remediated with mold-resistant drywall and paperless wallboard where practical. S.W.A.T. Restoration provides specific humidity targets and dehumidifier sizing guidance as part of the IAQ restoration scope.",
    },
    {
      question: "What MERV rating filter should I use after mold remediation?",
      answer:
        "Mold spores range from approximately 2 to 100 microns in diameter — MERV 8 filters capture particles above roughly 10 microns, which passes many of the smaller spore types. After a mold remediation event, S.W.A.T. Restoration typically recommends MERV 11 to MERV 13 filtration, which captures particles in the 1–3 micron range including the smaller spore types. The recommendation is matched to the HVAC system's air handler capacity — running a MERV 13 filter on a unit sized for MERV 8 increases static pressure and reduces airflow efficiency. S.W.A.T. Restoration specifies the MERV target for the equipment in place.",
    },
    {
      question: "Does insurance pay for post-remediation air testing?",
      answer:
        "Post-remediation clearance testing is typically covered as part of the mold remediation scope when the underlying moisture event is a covered loss. Some Texas homeowner policies include specific mold coverage endorsements that explicitly cover clearance testing; others treat it as part of the mitigation cost. S.W.A.T. Restoration includes clearance testing coordination in the documentation package submitted to the adjuster and bills the carrier directly for covered scopes.",
    },
    {
      question: "How long does indoor air quality restoration take after mold remediation?",
      answer:
