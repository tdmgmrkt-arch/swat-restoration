...
export const burstPipeCleanup: ServiceConfig = {
  slug: "burst-pipe-cleanup",
  href: "/water-damage/burst-pipe-cleanup",
  h1: "Burst Pipe Cleanup // Documentation, Drying & Repair Handoff",
  name: "Burst Pipe Cleanup",
  metaTitle: "Burst Pipe Cleanup Aledo, TX | S.W.A.T. Restoration",
  metaDescription:
    "Burst pipe cleanup in Aledo & Fort Worth, TX. S.W.A.T. Restoration handles documentation, structural drying & insurance coordination after a pipe failure — 24/7 response.",
  heroPainLine:
  ...
  processSteps: [
    {
      number: "01",
      label: "Moisture Map",
      title: "Find Everything the Leak Reached.",
      description:
    ...
    },
    {
      ...
      title: "Category 1 Water. Full Paper Trail.",
      description:
    ...
    },
    {
      ...
      title: "Dry the Framing, Not Just the Floor.",
      description:
    ...
    {
      number: "04",
      label: "Reconstruction Handoff",
      title: "Drying Complete. Rebuild Ready.",
      description:
  ...
  whySwatPillars: [
    {
      title: "Burst Pipe Cleanup Is Its Own Specialty — Not a Side Job.",
      bullets: [
    ...
    {
      title: "DFW Freeze Events — S.W.A.T. Restoration Is Ready.",
      bullets: [
    ...
    {
      title: "Mitigation Through Reconstruction. One Point of Contact.",
      bullets: [
  ...
  faqs: [
    {
      question: "How fast does S.W.A.T. Restoration respond to a burst pipe in Aledo?",
      answer:
        "S.W.A.T. Restoration targets under 60 minutes from dispatch to on-site across Aledo, Fort Worth, Benbrook, Weatherford, and Willow Park. A live dispatcher answers every call and confirms the crew is rolling before you hang up. During DFW freeze events — when multiple pipe failures happen across the area simultaneously — the Aledo hub on FM 1187 maintains dispatch capacity across Parker and Tarrant counties.",
    },
    {
      question: "What is the difference between burst pipe cleanup and emergency water extraction?",
      answer:
        "Emergency extraction is the first-response job — stopping the active event, removing the highest volume of standing water as fast as possible. Burst pipe cleanup is the follow-through: moisture mapping the full extent the water traveled, structural drying of wall cavities, framing, and subfloor assemblies to the IICRC S500 dry standard, and producing the documentation your insurance adjuster needs to scope the loss. Many burst pipe jobs require both phases; some calls come in after another crew already handled extraction and the homeowner still has wet walls.",
    },
    {
      question: "Will my homeowner's insurance cover burst pipe cleanup in Texas?",
      answer:
        "Most standard Texas homeowner policies cover sudden and accidental water damage from a burst supply line. Gradual leaks that went undetected over time are typically excluded. The distinction is documented on arrival — S.W.A.T. Restoration records the point of origin, the pipe failure classification (Category 1 under IICRC S500), and the mechanism of loss in the format adjusters expect. Direct billing to most major Texas carriers is available for covered losses.",
    },
    {
      question: "How long does drying take after a burst pipe?",
      answer:
        "A single-zone burst pipe loss in a residential structure typically dries in 3 to 5 days under active drying conditions — Phoenix dehumidifiers running continuously, Dri-Eaz air movers moving air across wet surfaces, and Injectidry equipment working the wall cavities. Multi-room losses or events where drying was delayed run longer. S.W.A.T. Restoration takes daily moisture readings and removes equipment only when materials reach the IICRC S500 dry standard — not on a fixed schedule.",
    },
    {
      question: "Can a burst pipe cause mold if the drywall looked dry after a few days?",
      answer:
