...
export const odorRemoval: ServiceConfig = {
  slug: "odor-removal",
  href: "/fire-damage/odor-removal",
  h1: "Smoke Odor Removal Aledo // Hydroxyl, Ozone & Deep Molecular Treatment",
  name: "Smoke Odor Removal",
  metaTitle: "Smoke Odor Removal Aledo, TX | S.W.A.T. Restoration",
  metaDescription:
    "Smoke odor removal in Aledo & Fort Worth, TX. S.W.A.T. Restoration eliminates deep fire odor with hydroxyl generators, ozone, and thermal fogging — IICRC S700-trained, insurance billing direct.",
  heroPainLine:
  ...
  processSteps: [
    {
      number: "01",
      label: "Odor Assessment",
      title: "Find the Source. Map the Depth.",
      description:
    ...
    },
    {
      number: "02",
      label: "Surface Prep",
      title: "Clean First. Treatment Can't Penetrate Active Residue.",
      description:
    ...
    {
      number: "03",
      label: "Hydroxyl or Ozone",
      title: "Molecular Destruction. Not Masking.",
      description:
    ...
    },
    {
      ...
      title: "Into the Cavities. Into the Ducts.",
      description:
  ...
  whySwatPillars: [
    {
      title: "Three-Method Protocol. No Single Treatment Gets All the Odor.",
      bullets: [
    ...
    {
      title: "Surface Cleaning Runs Before Molecular Treatment — Always.",
      bullets: [
    ...
    {
      title: "Aledo-Based. 24/7. Family Behind Every Job.",
      bullets: [
  ...
  faqs: [
    {
      question: "Why does smoke odor come back after the house was cleaned?",
      answer:
        "Surface cleaning removes visible soot but leaves odor-causing VOC molecules bonded inside porous materials — drywall paper, wood framing, insulation, and HVAC duct interiors. Those compounds off-gas back into the living space when temperature rises or the HVAC cycles on. Eliminating the odor requires molecular destruction — hydroxyl generation, ozone cycling, or thermal fogging — that reaches the same surfaces the smoke originally penetrated. S.W.A.T. Restoration runs a multi-day treatment cycle to confirm odor is eliminated, not masked.",
    },
    {
      question: "Is hydroxyl or ozone better for smoke odor removal?",
      answer:
        "Both destroy odor molecules through oxidation rather than masking them with fragrance. Hydroxyl generators are safe for use in occupied structures — family members and pets can remain in treated spaces. Ozone treatment is more aggressive and penetrates porous materials faster but requires full evacuation for 4 to 8 hours and a ventilation period before re-entry. S.W.A.T. Restoration selects the method — or uses both in sequence — based on occupancy requirements, the severity of odor penetration, and material types present.",
    },
    {
      question: "Does insurance cover smoke odor removal?",
      answer:
        "Smoke odor removal is typically covered under standard Texas homeowner fire policies as part of the mitigation and restoration scope. Coverage includes molecular treatment, thermal fogging, and HVAC decontamination. S.W.A.T. Restoration documents the treatment methods, contact times, and odor-level assessments in the format adjusters expect and bills the carrier directly for covered losses.",
    },
    {
      question: "How many days does smoke odor treatment take?",
      answer:
        "A localized odor event in one or two rooms typically requires 2 to 4 days: surface cleaning, one or two treatment cycles, and a ventilation assessment. A whole-structure fire with odor embedded throughout framing, insulation, and ductwork can require 5 to 10 days of treatment across multiple passes. S.W.A.T. Restoration assesses odor levels between cycles and documents the progression — the job is not complete until odor readings confirm molecular destruction, not just reduced intensity.",
    },
    {
      question: "Can smoke odor be removed from a house without replacing the drywall?",
      answer:
