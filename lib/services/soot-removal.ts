...
export const sootRemoval: ServiceConfig = {
  slug: "soot-removal",
  href: "/fire-damage/soot-removal",
  h1: "Soot Removal Aledo // Hard-Surface Cleaning & Pre-Paint Prep",
  name: "Soot Removal",
  metaTitle: "Soot Removal Aledo, TX | S.W.A.T. Restoration",
  metaDescription:
    "Soot removal in Aledo & Fort Worth, TX. S.W.A.T. Restoration cleans framing, drywall, and hard surfaces with matched chemistry — IICRC S700-trained, pre-paint ready, insurance billing direct.",
  heroPainLine:
  ...
  processSteps: [
    {
      number: "01",
      label: "Surface Assessment",
      title: "Categorize the Residue. Map the Affected Zone.",
      description:
    ...
    },
    {
      number: "02",
      label: "Dry Pass",
      title: "Lift the Loose. Before Any Liquid Touches the Surface.",
      description:
    ...
    },
    {
      number: "03",
      label: "Wet Chemistry",
      title: "Matched Degreaser for the Fire Type.",
      description:
    ...
    {
      number: "04",
      label: "Pre-Paint Inspection",
      title: "Hand Off to Reconstruction. Surface Is Ready.",
      description:
  ...
  whySwatPillars: [
    {
      title: "Chemistry-First Protocol. No Guesswork on the Surface Type.",
      bullets: [
    ...
    {
      title: "Pre-Paint Ready. Reconstruction Doesn't Stall.",
      bullets: [
    ...
    {
      title: "Aledo-Based. Serving DFW With 24/7 Response.",
      bullets: [
  ...
  faqs: [
    {
      question: "How quickly does soot damage surfaces after a fire?",
      answer:
        "Soot is acidic and begins reacting with surfaces within hours of a fire. Copper wiring and plumbing show oxidation within 72 hours. Chrome hardware begins to pit in under 24 hours in a high-soot environment. Drywall paper facing stains to the point where standard paint primer cannot cover it if soot sits for more than 48 to 72 hours. S.W.A.T. Restoration targets arrival under 60 minutes and begins surface assessment immediately to stop progressive corrosion damage.",
    },
    {
      question: "Does my insurance cover professional soot removal?",
      answer:
        "Soot and smoke damage cleanup is a standard covered cause under most Texas homeowner fire policies, including hard-surface cleaning, chemical treatment of framing and drywall, and pre-paint prep work. S.W.A.T. Restoration documents residue types, affected surfaces, chemistry used, and scope of cleaning in a format designed for adjuster review and bills the carrier directly for covered losses.",
    },
    {
      question: "Why can't I just paint over soot after a fire?",
      answer:
        "Soot is acidic and oily at the molecular level. Standard latex or oil paint applied over uncleaned soot fails to adhere and typically peels within weeks. Smoke odor compounds in the residue off-gas through fresh paint for months. Soot on wood framing accelerates rot and corrosion of metal fasteners if sealed in without removal. Professional soot removal neutralizes the pH and prepares the substrate so reconstruction paint bonds correctly and odor does not return.",
    },
    {
      question: "What is the difference between soot removal and smoke damage restoration?",
      answer:
        "Soot removal focuses on hard-surface and structural cleaning — framing, drywall, cabinets, trim, and contents — using matched chemistries to lift residue and prepare surfaces for reconstruction. Smoke damage restoration is the broader scope: it includes soot removal plus HVAC decontamination, thermal fogging for deep odor, and full structure treatment. S.W.A.T. Restoration scopes both on arrival and coordinates whichever combination the loss requires.",
    },
    {
      question: "How long does soot removal take in a fire-damaged home?",
      answer:
